...
3. Evaluación de calidad con GLEU (Google BLEU): métrica usada principalmente para evaluar modelos de traducción automática. Es especialmente útil en tareas donde es importante capturar todo el contenido de la referencia. Compara n-gramas (secuencias de palabras consecutivas) entre la frase generada y la referencia (1 = coincidencia perfecta, 0 = sin coincidencia).
